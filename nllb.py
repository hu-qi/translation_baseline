...
tokenizer = AutoTokenizer.from_pretrained("facebook/nllb-200-distilled-600M", token=False, src_lang="zho_Hans")
...
trans_tokenizer = AutoTokenizer.from_pretrained("./local_nllb_600m", token=False, src_lang="zho_Hans")
trans_model = AutoModelForSeq2SeqLM.from_pretrained("./local_nllb_600m", token=False)
